...
class FakeClient:
    ...
    def __init__(self, content: str = "  drafted text  ") -> None:
        ...
        self.chat = type("C", (), {"completions": _FakeCompletions(content, self.calls)})()
...
class BoomClient:
    ...
    def __init__(self) -> None:
        ...
        self.chat = type("C", (), {"completions": type("X", (), {"create": staticmethod(_raise)})()})()
...
def test_suggestions_reject_non_openai_client():
    with pytest.raises(TypeError):
        suggest_justification_text("c", "Cam", "confirmed", None, None, llm_client=object())
